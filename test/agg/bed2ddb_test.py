...
def test_clodius_aggregate_bedpe():
    input_file = op.join(testdir, "data", "isidro.bedpe")
...
def test_clodius_aggregate_bedpe2():
    ...
    input_file = op.join(testdir, "data", "galGal6.bed")
    chromsizes_file = op.join(testdir, "data", "galGal6.chrom.sizes")
    expected_file = op.join(testdir, "data", "galGal6.bed.multires.db")

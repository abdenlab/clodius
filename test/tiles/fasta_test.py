...
fasta_filename = op.join(testdir, "data", "GCA_000350705.1_Esch_coli_KTE11_V1_genomic.short.fna")
fai_filename = op.join(testdir, "data", "GCA_000350705.1_Esch_coli_KTE11_V1_genomic.short.fna.fai"
)

...
class MyTestCase(unittest.TestCase):
    def test_tileset_info(self):
        filename_matched = op.join(testdir, "data", "SRR1770413.sorted.short.bam")

        filename_mismatched = op.join(testdir, "data", "SRR1770413.mismatched_bai.bam")
    ...
    def test_tiles(self):
        ...
        index_filename = op.join(testdir, "data", "SRR1770413.different_index_filename.bai")
